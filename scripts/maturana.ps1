...
if (!(Test-Path -LiteralPath $cargo)) {
    throw "cargo.exe not found. Install Rust with: winget install --id Rustlang.Rustup -e (or use the prebuilt installer: irm https://www.maturana.sh/install.ps1 | iex)"
}
